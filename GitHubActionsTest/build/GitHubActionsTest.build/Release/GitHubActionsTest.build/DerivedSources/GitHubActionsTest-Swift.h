...
#ifndef GITHUBACTIONSTEST_SWIFT_H
#define GITHUBACTIONSTEST_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="GitHubActionsTest",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC17GitHubActionsTest12AppDelegatde")
@interface AppDelegatde : NSObject <NSApplicationDelegate>
...
SWIFT_CLASS("_TtC17GitHubActionsTest14ViewController")
